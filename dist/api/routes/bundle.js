        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              return _context.abrupt("return", res.status(200).json(bundles));

            case 12:
              return _context.abrupt("return", res.status(204).json(bundles));
            ...
            case 15:
              ...
              logger.error('error: %o', _context.t0);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 7:
              ...
              return _context3.abrupt("return", res.status(201).json(bundles));
